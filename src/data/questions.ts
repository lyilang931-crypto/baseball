...
const QUESTION_UUIDS = [
  ...
  // 配球テーマ追加10問用 (id 98-107)
  "a1000067-0000-4000-8000-000000000067",
  "a1000068-0000-4000-8000-000000000068",
  "a1000069-0000-4000-8000-000000000069",
  "a100006a-0000-4000-8000-00000000006a",
  "a100006b-0000-4000-8000-00000000006b",
  "a100006c-0000-4000-8000-00000000006c",
  "a100006d-0000-4000-8000-00000000006d",
  "a100006e-0000-4000-8000-00000000006e",
  "a100006f-0000-4000-8000-00000000006f",
  "a1000070-0000-4000-8000-000000000070",
  // 実データ傾向理解型10問 (id 108-117)
  "a1000071-0000-4000-8000-000000000071",
  "a1000072-0000-4000-8000-000000000072",
  "a1000073-0000-4000-8000-000000000073",
  "a1000074-0000-4000-8000-000000000074",
  "a1000075-0000-4000-8000-000000000075",
  "a1000076-0000-4000-8000-000000000076",
  "a1000077-0000-4000-8000-000000000077",
  "a1000078-0000-4000-8000-000000000078",
  "a1000079-0000-4000-8000-000000000079",
  "a100007a-0000-4000-8000-00000000007a",
] as const;
...
const QUESTIONS_POOL: Question[] = [
  ...
  // =====================================================================
  // 配球テーマ追加10問（id 98-107）: 球種選択・カウント・走者・左右・意図
  // =====================================================================
  {
    kind: "definition",
    questionType: "THEORY",
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 99,
    questionId: QUESTION_UUIDS[98],
    answerBiasLevel: "AVG",
    situation: "3-2フルカウント・走者1塁。左打者への配球で最も多いセオリーは？",
    count: "カウント 3-2",
    choices: [
      { id: "a", text: "ストレートでストライク勝負" },
      { id: "b", text: "スライダーで空振り狙い" },
      { id: "c", text: "チェンジアップで泳がせる" },
      { id: "d", text: "敬遠気味に外す" },
    ],
    answerChoiceId: "a",
    explanation:
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 100,
    questionId: QUESTION_UUIDS[99],
    answerBiasLevel: "LOW",
    situation: "初球・得点圏に走者あり。強打者を迎えたときの配球の狙いは？",
    count: "カウント 0-0",
    choices: [
      { id: "a", text: "ストレートで力勝負" },
      { id: "b", text: "変化球でファウルを打たせカウントを稼ぐ" },
      { id: "c", text: "際どいコースで見逃しを狙う" },
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 101,
    questionId: QUESTION_UUIDS[100],
    answerBiasLevel: "TOP",
    situation: "左投手vs左打者。内角攻めが基本とされる理由は？",
    count: "カウント 1-1",
    choices: [
      { id: "a", text: "同じ側からの球は角度がつきバットが届きにくい" },
      { id: "b", text: "左打者は内角が得意だから裏をかく" },
      { id: "c", text: "外角だとファウルになりやすい" },
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 102,
    questionId: QUESTION_UUIDS[101],
    answerBiasLevel: "MID",
    situation: "走者1塁3塁・1アウト。ゲッツー狙いの配球で有効な球種は？",
    count: "カウント 1-0",
    choices: [
      { id: "a", text: "高めのストレート" },
      { id: "b", text: "低めのシンカー（ツーシーム）" },
      { id: "c", text: "スライダー" },
      { id: "d", text: "カーブ" },
    ],
    answerChoiceId: "b",
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 103,
    questionId: QUESTION_UUIDS[102],
    answerBiasLevel: "AVG",
    situation: "2番手投手が登板直後。初対戦の打者への初球で多い選択は？",
    count: "カウント 0-0",
    choices: [
      { id: "a", text: "自信のある決め球で入る" },
      { id: "b", text: "ストレートでストライク先行" },
      { id: "c", text: "変化球で様子を見る" },
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 104,
    questionId: QUESTION_UUIDS[103],
    answerBiasLevel: "LOW",
    situation: "守備シフトで二塁手が右寄りに配置。この守備体系で投手が意識すべき配球は？",
    count: "カウント 0-1",
    choices: [
      { id: "a", text: "左方向に打たせる外角中心の配球" },
      { id: "b", text: "引っ張らせる内角中心の配球" },
      { id: "c", text: "三振狙いの高め中心" },
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 105,
    questionId: QUESTION_UUIDS[104],
    answerBiasLevel: "TOP",
    situation: "「見せ球」として変化球を使う目的で最も適切なものは？",
    count: "カウント 1-1",
    choices: [
      { id: "a", text: "打者の目線をずらし決め球の効果を高める" },
      { id: "b", text: "球数を稼いで体力を温存する" },
      { id: "c", text: "ストライクゾーンを広げる" },
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 106,
    questionId: QUESTION_UUIDS[105],
    answerBiasLevel: "MID",
    situation: "先発投手が6回100球目前。「打たせて取る」配球に切り替える判断基準として正しいのは？",
    count: "カウント 0-0",
    choices: [
      { id: "a", text: "球速が落ちてきたら低めのツーシームで打たせる" },
      { id: "b", text: "三振を狙い続けて球数を増やす" },
      { id: "c", text: "変化球の割合を増やして空振りを取る" },
  ...
  },
  {
    ...
    questionType: "THEORY",
    id: 107,
    questionId: QUESTION_UUIDS[106],
    answerBiasLevel: "AVG",
    situation: "同じ打者に対して3打席目。前2打席で外角ストレートを狙い打ちされた。3打席目の初球は？",
    count: "カウント 0-0",
    choices: [
      { id: "a", text: "同じ外角ストレートで裏をかく" },
      { id: "b", text: "インコースの変化球で意識を変える" },
      { id: "c", text: "高めのストレートで目線を上げさせる" },
  ...
  // ═══════════════════════════════════════════════════════════════
  // 実データ傾向理解型 10問 (id 108-117)
  // MLB Statcast / NPB公式の検証可能なデータに基づく
  // ═══════════════════════════════════════════════════════════════
  {
    kind: "stat",
    questionType: "REAL_DATA",
    id: 108,
    questionId: QUESTION_UUIDS[107],
    answerBiasLevel: "MID",
    mode: "pitching",
    situation:
      "MLB 2023：3-1（打者有利）カウントで投手が最も多く選んだ球種は？",
    count: "3ボール1ストライク",
    choices: [
      { id: "a", text: "4シーム" },
      { id: "b", text: "スライダー" },
    ...
    answerChoiceId: "a",
    explanation:
      "打者有利カウントでは投手の約70%が4シームを選択。\nストライクゾーンに入れる必要があるため、最もコントロールしやすい速球系が主流。変化球はボールになるリスクが高い。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 3,
    season: 2023,
    metric: "Pitch Usage (3-1 count)",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 109,
    questionId: QUESTION_UUIDS[108],
    answerBiasLevel: "AVG",
    mode: "pitching",
    situation:
      "MLB 2023：0-2から投手がストライクゾーン外に投げた割合はおよそ？",
    count: "0ボール2ストライク",
    choices: [
      { id: "a", text: "約40%（半分近くはゾーン内）" },
      { id: "b", text: "約60%（大半がボール球）" },
      { id: "c", text: "約80%（ほぼ全てボール球）" },
      { id: "d", text: "約25%（ゾーン内が主流）" },
    ],
    answerChoiceId: "b",
    explanation:
      "0-2では約60%がゾーン外への投球。\n「釣り球」で打者を誘い、ボール球を振らせる配球が定石。ただし完全にゾーンを外すと痛打を避けられるが四球のリスクもある。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 4,
    season: 2023,
    metric: "Zone% (0-2 count)",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 110,
    questionId: QUESTION_UUIDS[109],
    answerBiasLevel: "LOW",
    situation:
      "MLB 2023：ピッチクロック導入で平均試合時間はどれだけ短縮した？",
    count: "知識問題",
    choices: [
      { id: "a", text: "約10分" },
      { id: "b", text: "約20分" },
    ...
    answerChoiceId: "c",
    explanation:
      "2023年のピッチクロック導入で平均試合時間が約30分短縮（3時間6分→2時間36分）。\nMLB史上最大の時短効果。テンポ改善で観客満足度も向上した。",
    sourceLabel: "MLB公式",
    sourceUrl: "https://www.mlb.com/news/pitch-timer-rules-2023",
    sourceType: "data",
    difficulty: 3,
    season: 2023,
    metric: "Game Duration Change",
    league: "MLB",
    source_url: "https://www.mlb.com/news/pitch-timer-rules-2023",
  },
  {
    kind: "stat",
    questionType: "REAL_DATA",
    id: 111,
    questionId: QUESTION_UUIDS[110],
    answerBiasLevel: "MID",
    situation:
      "MLB 2023：盗塁数が前年比で約30%増加した主な要因は？",
    count: "知識問題",
    choices: [
      { id: "a", text: "ピッチクロック＋ベース拡大のルール変更" },
      { id: "b", text: "走力のある若手選手が大量にデビュー" },
      { id: "c", text: "シフト禁止で内野手の位置が変わった" },
      { id: "d", text: "盗塁を重視する監督が増えた" },
    ],
    answerChoiceId: "a",
    explanation:
      "ピッチクロックで牽制回数が制限（2回まで）され、ベースが15→18インチに拡大。\n投手がランナーを警戒しにくくなり、盗塁成功率が80%超に上昇。成功率が上がったことで盗塁の試行数自体も急増した。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 3,
    season: 2023,
    metric: "Stolen Base Increase",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 112,
    questionId: QUESTION_UUIDS[111],
    answerBiasLevel: "TOP",
    mode: "pitching",
    situation:
      "MLB 2023：初球をストライクにした場合と、ボールにした場合で打者の最終打率はどう変わる？",
    count: "カウント 0-0",
    choices: [
      { id: "a", text: "ストライク後 .230 / ボール後 .270" },
      { id: "b", text: "ストライク後 .250 / ボール後 .260" },
      { id: "c", text: "ストライク後 .240 / ボール後 .290" },
      { id: "d", text: "ほとんど変わらない" },
    ],
    answerChoiceId: "a",
    explanation:
      "初球ストライクを取ると打者打率が約40ポイント低下。\n投手側が主導権を握り、2球目以降の配球の自由度が大幅に広がる。初球の重要性がデータで裏付けられている。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 4,
    season: 2023,
    metric: "BA by First Pitch Result",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 113,
    questionId: QUESTION_UUIDS[112],
    answerBiasLevel: "AVG",
    mode: "pitching",
    situation:
      "MLB 2023：リリーフ投手の平均球速は先発投手と比べてどのくらい速い？",
    count: "知識問題",
    choices: [
      { id: "a", text: "ほぼ同じ（0.5mph以下の差）" },
      { id: "b", text: "約1-2mph速い" },
      { id: "c", text: "約2-3mph速い" },
      { id: "d", text: "約4mph以上速い" },
    ],
    answerChoiceId: "c",
    explanation:
      "リリーフは1-2イニング全力で投げるため、先発より平均2-3mph速い。\nこの球速差が終盤の打者にとって大きな壁になる。先発の球速に慣れた後のリリーフは体感速度がさらに上がる。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 3,
    season: 2023,
    metric: "Avg Velocity SP vs RP",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 114,
    questionId: QUESTION_UUIDS[113],
    answerBiasLevel: "MID",
    mode: "pitching",
    situation:
      "NPB 2023：先発投手の1試合あたり平均投球数はおよそ何球？",
    count: "知識問題",
    choices: [
      { id: "a", text: "約80球" },
      { id: "b", text: "約95球" },
    ...
    answerChoiceId: "b",
    explanation:
      "NPBの先発投手の平均投球数は約90-100球。\n近年は投手保護の観点から100球前後での交代が主流。MLBはさらに少なく約87球。効率的な投球（打たせて取る）が重要視されている。",
    sourceLabel: "NPB公式",
    sourceUrl: "https://npb.jp/bis/2023/stats/pit_c.html",
    sourceType: "data",
    difficulty: 2,
    season: 2023,
    metric: "Avg Pitches per Start",
    league: "NPB",
    source_url: "https://npb.jp/bis/2023/stats/pit_c.html",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 115,
    questionId: QUESTION_UUIDS[114],
    answerBiasLevel: "LOW",
    mode: "pitching",
    situation:
      "MLB 2023：フルカウント（3-2）からの打者の打率は通常カウントと比べてどうなる？",
    count: "3ボール2ストライク",
    choices: [
      { id: "a", text: "大幅に上がる（.300以上）" },
      { id: "b", text: "やや上がる（.260付近）" },
      { id: "c", text: "やや下がる（.230付近）" },
      { id: "d", text: "大幅に下がる（.200以下）" },
    ],
    answerChoiceId: "c",
    explanation:
      "フルカウントでの打率は約.230で全体平均より低い。\n投手も打者もプレッシャーがかかるが、投手はストライクを取らなければならず、打者も「見逃し三振」を恐れて精度の低いスイングをしやすい。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 4,
    season: 2023,
    metric: "BA on 3-2 Count",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 116,
    questionId: QUESTION_UUIDS[115],
    answerBiasLevel: "AVG",
    situation:
      "MLB 2023：「バレルゾーン」（長打が出やすい打球）の条件に最も近いのは？",
    count: "知識問題",
    choices: [
      { id: "a", text: "打球速度95mph以上・角度10-20度" },
      { id: "b", text: "打球速度98mph以上・角度26-30度" },
      { id: "c", text: "打球速度90mph以上・角度30-40度" },
      { id: "d", text: "打球速度100mph以上・角度15-25度" },
    ],
    answerChoiceId: "b",
    explanation:
      "Statcastの「バレルゾーン」は打球速度98mph以上＋打球角度26-30度が中心。\nこの条件を満たすと打率.500以上・長打率1.500以上が期待できる。打者は「いかにバレルに入れるか」が現代野球の鍵。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 4,
    season: 2023,
    metric: "Barrel Zone Definition",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
  {
    ...
    questionType: "REAL_DATA",
    id: 117,
    questionId: QUESTION_UUIDS[116],
    answerBiasLevel: "TOP",
    mode: "pitching",
    situation:
      "MLB 2023：ランナー1塁の場面で投手が初球に最も多く選んだ球種は？",
    count: "カウント 0-0（ランナー1塁）",
    choices: [
      { id: "a", text: "4シーム" },
      { id: "b", text: "シンカー・ツーシーム" },
      { id: "c", text: "スライダー" },
      { id: "d", text: "チェンジアップ" },
    ],
    answerChoiceId: "b",
    explanation:
      "ランナー1塁では併殺を狙うためゴロ球であるシンカー・ツーシーム系が最多。\n通常の初球は4シームが最多だが、ゲッツー狙いの場面ではゴロを打たせる球種にシフトするのがデータ上の傾向。",
    sourceLabel: "Baseball Savant",
    sourceUrl: "https://baseballsavant.mlb.com/leaderboard/statcast",
    sourceType: "data",
    difficulty: 5,
    season: 2023,
    metric: "Pitch Type with Runner on 1B",
    league: "MLB",
    source_url: "https://baseballsavant.mlb.com/leaderboard/statcast",
  },
];
 ...
 */
const PITCHING_REAL_IDS = [11, 53, 54, 55, 56, 59, 61, 62, 63, 65, 66, 68, 69, 71, 73, 74, 76, 108, 109, 112, 113, 115, 117];
